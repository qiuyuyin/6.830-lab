...
public class Aggregate extends Operator {
    ...
    public Aggregate(OpIterator child, int afield, int gfield, Aggregator.Op aop) {
        ...
        if (afieldType == Type.INT_TYPE) {
            aggregator = new IntegerAggregator(gfield,fieldType,afield,aop);
        } else {
            aggregator = new StringAggregator(gfield,fieldType,afield,aop);
        }
    ...
    public String groupFieldName() {
        // some code goes here
        return this.opIterator.getTupleDesc().getFieldName(0);
    }
